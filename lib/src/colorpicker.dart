...
class ColorPicker extends StatefulWidget {
  const ColorPicker({
    ...
    // The default value is 0.0, which means no cropping.
    // cropRadius is the radius of the cropping circle.
    // It is added to the package to crop the color picker area.
    this.cropRadius = 0.0,
  }) : super(key: key);
    ...
    return ClipRRect(
      ...
      child: Padding(
        ...
        child: ColorPickerArea(currentHsvColor, onColorChanging,
            widget.paletteType, widget.cropRadius),
      ),
    );
  }
            ...
            child: SizedBox(
              ...
              child: ClipRRect(
                ...
                child: ColorPickerArea(
                    currentHsvColor, onColorChanging, PaletteType.hsv, 0.0),
              ),
            ),
          ),
          ClipRRect(
